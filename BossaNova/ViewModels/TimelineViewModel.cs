...
namespace Tasks.Show.ViewModels
{
    public class TimelineViewModel : INotifyPropertyChanged
    {
        ...
        private DateTime m_beginDate = DateTime.Now; //DateTime.Now.AddMonths(-1);
        ...
        private void RefreshDates(bool showNow)
        {
            ...
            // Adjust the dates. Wwe want to get the range of dates for all of the visible
            // data but always show at least 1 month in the past and 1 month the future.
            // We won't show events more than 1 year in the past or 1 year in the future.
            ...
            if (showNow)
            {
                ...
                This did not work correcly (days per month were incorrect)...
                this.BeginDate = DateTime.Today.AddMonths(-2);

                The PixelLab calendar control is mysterious, I don't have
                enough experience with it to make the proper modifications.
                I will revisit this in the future when I have more time.
                */
            ...
            // Generate a collection of dates that we can use to populate the labels on our timeline.
            DateTime date = begin;
    ...
    /// <summary>
    /// <see cref="TimeSpan"/> to height converter.
    /// </summary>
