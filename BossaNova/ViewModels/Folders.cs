...
namespace Tasks.Show.ViewModels
{
    public class Folders
    {
        ...
        public ICommand SetCurrentColorCommand
        {
            get
            {
                System.Diagnostics.Debug.WriteLine($"[SetCurrentColorCommand]");
                return m_setCurrentColorCommand.Command; 
            }
        }
        ...
        public ICommand SetCurrentCommand
        {
            get
            {
                System.Diagnostics.Debug.WriteLine($"[SetCurrentCommand]");
                return m_setCurrentCommand.Command;
            }
        }
