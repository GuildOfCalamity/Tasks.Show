    ...
    public partial class DateDropDown : UserControl
    {
        ...
        private void RefreshDates()
        {
            if (lastRefresh.Date != DateTime.Today)
            {
                ...
                Dates.Add(new LabeledDateTime("Two Weeks from Today", DateTime.Today.AddDays(14)));
                Dates.Add(new LabeledDateTime("One Month from Today", DateTime.Today.AddMonths(1)));
                Dates.Add(new LabeledDateTime("Two Months from Today", DateTime.Today.AddMonths(2)));
                Dates.Add(new LabeledDateTime("One Year from Today", DateTime.Today.AddYears(1)));
