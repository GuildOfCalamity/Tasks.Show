...
namespace Microsoft.Shell
{
    ...
    public static class SingleInstance<TApplication> where TApplication : Application, ISingleInstanceApp
    {
        ...
        {
            Tasks.Show.App.Logger.WriteLine($"Signaling first instance of {channelName}", Tasks.Show.LogLevel.Debug);
        ...
        private static void ActivateFirstInstance(IList<string> args)
        {
            ...
            Tasks.Show.App.Logger.WriteLine($"Activating first instance", Tasks.Show.LogLevel.Debug);
