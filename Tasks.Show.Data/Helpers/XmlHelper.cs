...
namespace Tasks.Show.Helpers
{
    public static class XmlHelper
    {
        ...
        public static XElement ToXml(this TaskData taskData)
        {
            ...
            {
                System.Windows.MessageBox.Show($"{ex.Message}", "Tasks.Show.Helpers.ToXml", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Exclamation);
            }
        ...
        public static XElement ToXml(this IEnumerable<Folder> folders, out IDictionary<Folder, Guid> folderMap)
        {
            ...
            {
                System.Windows.MessageBox.Show($"{ex.Message}", "Tasks.Show.Helpers.ToXml_", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Exclamation);
            }
        ...
        public static IEnumerable<Folder> GetFolders(XElement element, out IDictionary<Guid, Folder> folderMapper)
        {
            ...
            {
                System.Windows.MessageBox.Show($"{ex.Message}", "Tasks.Show.Helpers.GetFolders", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Exclamation);
            }
